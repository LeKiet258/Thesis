...
def get_dataloaders(input_paths, target_paths, batch_size, is_train):
    '''return train/test/val dataloaders. Arguments:
        ...
        - input_paths: a list of input image file paths'''
    ...
    if is_train:
        ...
        train_dataloader = data.DataLoader(
            ...
            shuffle=True,
            drop_last= False if len(train_indices) % batch_size == 0 else True, # bỏ đi batch cuối vì dataset is not divisible by your batch_size; False nếu mún giữ lại
